  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.mediaRow}>
            <Image
              src="/kepek-webp/Dani Honlap Apr 16 2025 (1).webp"
        ...
        <section id="rolunk" className={styles.section}>
          <div className="container split">
            ...
            <div className="img-wrap ratio-3-2 maxh-480">
              <Image
                src="/kepek-webp/Csend Image from Dani.webp"
        ...
        <section id="felszereltseg" className={styles.section}>
          ...
          <div className={styles.features}>
            <div className={styles.featureCard}>
              ...
              <Image
                src="/kepek-webp/Equipped Kitchen.webp"
            ...
            <div className={styles.featureCard}>
              ...
              <div className={styles.mediaGrid2}>
                <Image
                  src="/kepek-webp/Jacuzzi for Relaxation.webp"
                ...
                loading="lazy" />
                <Image
                  src="/kepek-webp/Pihentető Infraszauna.webp"
            ...
            <div className={styles.featureCard}>
              ...
              <div className={styles.mediaGrid2}>
                <Image
                  src="/kepek-webp/Dani Honlap Apr 07 2025.webp"
                ...
                loading="lazy" />
                <Image
                  src="/kepek-webp/Erdei Túrák.webp"
        ...
        <section id="galeria" className={styles.section}>
          ...
          <div className={styles.galleryGrid}>
            ...
            <figure className={`${styles.card} ${styles.span2}`}>
              <Image src="/kepek-webp/Dani Honlap Apr 16 2025.webp" alt="A-frame homlokzat, terasz" width={1600} height={1066} />
              <figcaption>Első találkozás a házzal; natúr fa, grafitszürke tető.</figcaption>
            </figure>
            {/* 2 */}
            <figure className={styles.card}>
              <Image src="/kepek-webp/Honlap Dani (1).webp" alt="Erdei bekötőút" width={1600} height={1066} />
              <figcaption>Az érkezés is élmény; fák ölelésében kanyarog az út.</figcaption>
            </figure>
            {/* 3 */}
            <figure className={styles.card}>
              <Image src="/kepek-webp/Dani Honlap Apr 16 2025 (1).webp" alt="Háromszög ablak – reggeli fény" width={1600} height={1066} />
              <figcaption>A lombokon átszűrődő napfény a hálótérben.</figcaption>
            </figure>
            {/* 4 */}
            <figure className={styles.card}>
              <Image src="/kepek-webp/Dani Honlap Jun 25 2025.webp" alt="Belső tér az üveg tolóajtón át" width={1600} height={1066} />
              <figcaption>A terasz és az erdő egyetlen nagy nappalivá áll össze.</figcaption>
            </figure>
            {/* 5 */}
            <figure className={styles.card}>
              <Image src="/kepek-webp/Equipped Kitchen.webp" alt="Konyha közelről" width={1600} height={1066} />
              <figcaption>Tiszta vonalak, kényelmes főzés kettesben.</figcaption>
            </figure>
            {/* 6 */}
            <figure className={styles.card}>
              <Image src="/kepek-webp/Csend Image from Dani.webp" alt="Előlapi nézet – nyitott ajtókkal" width={1600} height={1066} />
              <figcaption>A ház és a természet határán.</figcaption>
            </figure>
            {/* 7 */}
            <figure className={styles.card}>
              <Image src="/kepek-webp/Honlap Dani.webp" alt="Kültéri lépcső és teraszburkolat" width={1600} height={1066} />
              <figcaption>Természetes textúrák, praktikus megoldások.</figcaption>
            </figure>
            {/* 8 */}
            <figure className={styles.card}>
              <Image src="/kepek-webp/Dani Honlap July 27 2025.webp" alt="Kert & kerítés, ösvény" width={1600} height={1066} />
              <figcaption>Csendes délutánok a fák között.</figcaption>
            </figure>
            {/* 9 */}
            <figure className={styles.card}>
              <Image src="/kepek-webp/Jacuzzi for Relaxation.webp" alt="Wellness – jakuzzi" width={1600} height={1066} />
              <figcaption>Esti csillagnézés meleg vízben.</figcaption>
            </figure>
            {/* 10 */}
            <figure className={styles.card}>
              <Image src="/kepek-webp/Pihentető Infraszauna.webp" alt="Wellness – infraszauna" width={1600} height={1066} />
              <figcaption>Lazítás esőnapokon is.</figcaption>
            </figure>
            {/* 11 */}
            <figure className={styles.card}>
              <Image src="/kepek-webp/Erdei Túrák.webp" alt="Erdei részlet" width={1600} height={1066} />
              <figcaption>Friss levegő, madárdal, simogató zöldek.</figcaption>
            </figure>
            {/* 12 */}
            <figure className={styles.card}>
              <Image src="/kepek-webp/Dani Honlap June 25 2025.webp" alt="Oldalnézet – tetősík, fa homlokzat" width={1600} height={1066} />
              <figcaption>Karakteres A-keret forma.</figcaption>
            </figure>
            {/* 13 */}
            <figure className={styles.card}>
              <Image src="/kepek-webp/Erdei Álmok.webp" alt="Belső háromszög kuckó" width={1600} height={1066} />
              <figcaption>Meghitt, természetközeli pihenő.</figcaption>
            </figure>
            {/* 14 */}
            <figure className={styles.card}>
              <Image src="/kepek-webp/Dani Honlap Apr 16 2025 (1).webp" alt="Terasz – erdő felé" width={1600} height={1066} />
              <figcaption>Reggeli kávé színpada.</figcaption>
            </figure>
            {/* 15 */}
            <figure className={styles.card}>
              <Image src="/kepek-webp/Dani Honlap Apr 07 2025.webp" alt="Előkert, lépcsős feljáró" width={1600} height={1066} />
              <figcaption>Kényelmes megközelítés.</figcaption>
            </figure>
            {/* 16 */}
            <figure className={styles.card}>
              <Image src="/kepek-webp/Dani Honlap Apr 16 2025.webp" alt="Front – nappali fényben" width={1600} height={1066} />
              <figcaption>A ház nappal és este is fotogén.</figcaption>
            </figure>
            {/* 17 */}
            <figure className={styles.card}>
              <Image src="/kepek-webp/Honlap Dani (1).webp" alt="Érkezés – távolabbi totál" width={1600} height={1066} />
          ...
          <div className={styles.pricingWrap}>
            ...
            <aside className={styles.priceCard}>
              ...
              <div style={{marginTop:12}}>
                <Image
                  src="/kepek-webp/Dani Honlap Jun 25 2025.webp"
